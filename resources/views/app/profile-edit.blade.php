...
<x-layouts.app title="Profile settings | Sirraty">
    ...
    <form class="panel" method="POST" action="{{ route('app.profile.update') }}" enctype="multipart/form-data">
        ...
        <div class="field media-upload-field" data-auto-media-upload data-upload-url="{{ route('app.profile.media') }}" data-upload-field="avatar" data-target-input="avatar_url">
            <span>Avatar</span>
            <input name="avatar_url" type="hidden" value="{{ old('avatar_url', $profile->avatar_url ?? '') }}">
        ...
        <div class="field media-upload-field" data-auto-media-upload data-upload-url="{{ route('app.profile.media') }}" data-upload-field="cover" data-target-input="cover_url">
            <span>Cover</span>
            <input name="cover_url" type="hidden" value="{{ old('cover_url', $profile->cover_url ?? '') }}">
            <div class="media-upload-row">
