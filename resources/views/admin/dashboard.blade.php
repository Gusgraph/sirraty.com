...
<x-layouts.app title="Admin Zone | Sirraty">
    ...
    <div class="grid" style="grid-template-columns:repeat(auto-fit,minmax(173px,1fr));margin-bottom:19px">
        @php($links = ['Users' => 'users', 'Profiles' => 'profiles', 'Posts' => 'posts', 'Comments' => 'comments', 'Pages' => 'pages', 'Groups' => 'groups', 'Market listings' => 'market-listings', 'Reports' => 'reports', 'Moderation cases' => 'moderation-queue', 'Word filters' => 'word-filters', 'Locations' => 'locations', 'Categories' => 'categories'])
        @foreach($counts as $label => $count)
            <a class="panel" href="{{ route('admin.section', $links[$label]) }}">
